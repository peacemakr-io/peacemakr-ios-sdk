...
open class KeyDerivationServiceRegistryAPI {
  ...
  "version" : "version"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllOrgKeyDerivationServiceInstances(completion: @escaping ((_ data: [KeyDerivationInstance]?,_ error: Error?) -> Void)) {
        getAllOrgKeyDerivationServiceInstancesWithRequestBuilder().execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
    ...
    /**
     Get the all key derivers registerd to org
     - GET /crypto/deriver/all-org-instances
     - API Key:
       - type: apiKey authorization 
       - name: header
     - examples: [{contentType=application/json, example=[ {
  ...
  "version" : "version"
     ...
     - returns: RequestBuilder<[KeyDerivationInstance]> 
     */
    open class func getAllOrgKeyDerivationServiceInstancesWithRequestBuilder() -> RequestBuilder<[KeyDerivationInstance]> {
        let path = "/crypto/deriver/all-org-instances"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllSharedKeyDerivationServiceInstances(completion: @escaping ((_ data: [KeyDerivationInstance]?,_ error: Error?) -> Void)) {
        getAllSharedKeyDerivationServiceInstancesWithRequestBuilder().execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
    ...
    /**
     Get the all key derivers that the org has access to - including shared cloud instances
     - GET /crypto/deriver/all-shared-instances
     - API Key:
       - type: apiKey authorization 
       - name: header
     - examples: [{contentType=application/json, example=[ {
  ...
  "version" : "version"
     ...
     - returns: RequestBuilder<[KeyDerivationInstance]> 
     */
    open class func getAllSharedKeyDerivationServiceInstancesWithRequestBuilder() -> RequestBuilder<[KeyDerivationInstance]> {
        let path = "/crypto/deriver/all-shared-instances"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
